...
// @group(Lighting Output; _Output)
// @param hidden enum _Output = Both {Both: 0, HighlightOnly: 1, ShadowOnly: 2} // Select the transparent lighting component. No effect when Base Color alpha is 1.
...
float4 ApplyFX(float2 uv, float4 color)
{
    ...
    n.y *= lerp(1.0, -1.0, step(0.5001, _FlipY));
